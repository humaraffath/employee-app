...
public class LeaveService {
    ...
    public LeaveApplicationResponse approve(Long leaveApplicationId) {
        ...
        employee.setLeaveBalance(
                employee.getLeaveBalance() - (int) duration);
    ...
    @PreAuthorize("hasAnyRole('HR', 'ADMIN')")
    public LeaveApplicationResponse reject(
        ...
        leaveApplication.setRejectionReason(
    ...
    public LeaveApplicationResponse getById(Long id) {
        ...
        return toResponse(
                findLeaveApplicationOrThrow(id));
    }
    ...
    @Transactional(readOnly = true)
    public List<LeaveApplicationResponse> getByStatus(
            LeaveStatus status) {
    ...
    private LeaveApplicationResponse toResponse(
        ...
        return LeaveApplicationResponse.builder()
                ...
                .rejectionReason(
                        leaveApplication.getRejectionReason())
                .build();
    }
}